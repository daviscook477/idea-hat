...
.controller('CommentsCtrl', ['$scope', '$stateParams', 'Firebase', function($scope, $stateParams, Firebase) {
	...
	var cbSuccess = function(snapshot) {
		$scope.$apply(function() { //Make sure that the page is updated with these changes to it
